			...
			<div class="col-md-9">
				<div class="card">
					<div class="card-body">
						...
						<button class="btn btn-danger mt-1" id="apply_coupon"style="background: linear-gradient(to top, #b31217, #e52d27);">Apply</button><br>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="card">
					<div class="card-body">
						...
						<button class="btn btn-danger btn-block" id="pay"style="background: linear-gradient(to top, #b31217, #e52d27);">Pay Now</button>
					</div>
				</div>
			</div>
		</div>
