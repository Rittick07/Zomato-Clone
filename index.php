...
<body>
	...
	<div class="container-fluid">
		<h4>Order Food Online in Durgapur</h4>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<div class="row">
											<div class="col-md-3">
												<img class="card-img" src="'.$row['r_logo'].'">
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-3">
												<p style="text-align: right;">';
													...
													elseif($row['r_rating']>=3 && $row['r_rating']<4.0){
									...
									<div class="col-md-12">
										<a href="order.php?id='.$row['r_id'].'" class="btn btn-sm btn-danger float-right"style="background: linear-gradient(to top, #b31217, #e52d27);">Order Now</a>
									</div>
								</div>
							</div>
						</div>
